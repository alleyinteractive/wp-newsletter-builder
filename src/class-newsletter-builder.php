...
class Newsletter_Builder {
	...
	public function __construct() {
		...
		add_filter( 'newsletter_builder_html_url', [ $this, 'modify_html_url' ], 10, 2 );
	...
	public function register_post_type() {
		register_post_type(
			...
			[
				'labels'              => [
					'name'          => __( 'Newsletters', 'newsletter-builder' ),
					'singular_name' => __( 'Newsletter', 'newsletter-builder' ),
				],
				'public'              => true,
				'has_archive'         => true,
				...
				'template'            => [
					[
						'newsletter-builder/email-settings',
						[
							'lock' => [
								'move'   => true,
								'remove' => true,
	...
	public function include_template( $template ) {
		...
		$local_path = NEWSLETTER_BUILDER_DIR . '/single-nb_newsletter.php';
